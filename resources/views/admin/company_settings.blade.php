													...
													<ul>
														...
														<li class="submenu">
															...
															<ul>
																...
																<li class="active"><a href="company-settings.html">Company Settings </a></li>
											...
											<div class="row">
												...
												<div class="col-xl-4 col-lg-6 col-md-4">
													<div class="mb-3">
														...
														<input type="email" name="company_email" value="{{$setting->company_email}}"class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="mb-3">
														<label class="form-label">Phone Number</label>
														<input type="text" name="company_number" value="{{$setting->company_number}}"class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="mb-3">
														<label class="form-label">Fax</label>
														<input type="text" name="company_fax" value="{{$setting->company_fax}}"class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="mb-3">
														<label class="form-label">Website</label>
														<input type="text" name="company_website" value="{{$setting->company_website}}"class="form-control">
													</div>
												</div>
											</div>
										</div>
											...
											<ul class="logo-company">
												<li class="d-flex align-items-center">
													...
													<div class="new-logo ms-auto">
														<a href="#"><img src="assets/img/logo-small.png" alt="Logo"><span><i data-feather="x"></i></span></a>
													</div>
												</li>
												<li class="d-flex align-items-center">
													<div class="logo-info">
											...
											<div class="row">
												...
												<div class="col-xl-3 col-lg-4 col-md-3">
													<div class="mb-3">
														...
														<input type="text" name="state" value="{{$setting->state}}"class="form-control">
													</div>
												</div>
												<div class="col-xl-3 col-lg-4 col-md-3">
													<div class="mb-3">
														...
														value="{{$setting->city}}"class="form-control">
													</div>
												</div>
												<div class="col-xl-3 col-lg-4 col-md-3">
													<div class="mb-3">
														<label class="form-label">Postal Code</label>
														<input type="text" name="postal_code" value="{{$setting->postal_code}}"class="form-control">
													</div>
												</div>
											</div>
										</div>
