...
<div class="page-wrapper">
	<div class="content">
		<div class="page-header">
			...
			<div class="page-btn">
				<a href="add-product.html" class="btn btn-added"><i data-feather="plus-circle" class="me-2"></i>Add New
					Product</a>
			</div>
						...
						<tbody>
							@foreach($product as $products)
								<tr>
									...
									<td>{{ $products->category->category_name ?? 'no available category'}}</td>
